...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  describe('Verifica se a função `getCharacter` retorna o objeto do personagem corretamente.', () => {
    ...
    it('Verifica se a função retorna o objeto correto para o parâmetro "Brienne"', () => {expect(getCharacter('Brienne')).toEqual({ name: 'Brienne Tarth', class: 'Knight', phrases: ['Im No Lady, Your Grace.', 'I, Brienne Of Tarth, Sentence You To Die.'],
  });});
    
    it('Verifica se a função retorna o objeto correto para o parâmetro "Melissandre"', () => {expect(getCharacter('Melissandre')).toEqual({ name: 'Melissandre', class: 'Necromancer', phrases: ['Death By Fire Is The Purest Death.', 'For The Night Is Dark And Full Of Terrors.'],
  });});
